...
def main():    
    # 從最佳權重開始進行精調
    model = YOLO("train_yoga5/train_stage3/weights/best.pt")
    ...
    # 使用第一階段的最佳權重
    model = YOLO("train_yoga5_2/train_stage1/weights/best.pt")
    print("開始第二階段訓練...")
    results2 = train_stage2(model)
    
    # 使用第二階段的最佳權重
    model = YOLO("train_yoga5_2/train_stage2/weights/best.pt")
    print("開始第三階段訓練...")
